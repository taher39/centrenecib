export default {
  ...
  common: { save: "Save", cancel: "Cancel", confirm: "Confirm", delete: "Delete", edit: "Edit", add: "Add", search: "Search", loading: "Loading…", today: "Today", tomorrow: "Tomorrow", currency: "DZD", back: "Back", actions: "Actions", date: "Date", time: "Time", price: "Price", duration: "Duration", minutes: "min", name: "Name", phone: "Phone", age: "Age", address: "Address", gender: "Gender", male: "Male", female: "Female", notes: "Notes", total: "Total", required: "Required field", install: "Install app", language: "Language", create: "Create", close: "Close", print: "Print" },
  client: {
    welcome: "Welcome",
